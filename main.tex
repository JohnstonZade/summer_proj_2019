...
\begin{document}
  ...
  Rewrote the PDF code, and ended up getting the Fourier transform method giving a closer result to the paper than straight calculating it from $\Delta p$. It does look a little too symmetrical however so will investigate and put screenshots up tomorrow.
