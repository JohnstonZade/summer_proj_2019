...
\begin{document}
  ...
  The next steps are working on updating the code to calculate the $l_{/|}$ and $l_\perp$ components of the separation vector relative to the magnetic field to observe the critical balance law, and then to talk with Jono about working with his modified Athena code.
